        ...
        <div class="slider-wrapper">
          <div class="slider">
            ...
            @isset($service->service_conditions)
              <div class="slider-item" data-image='{{ asset('uploads/images/165598426955181548162917388368489.png') }}'>
                <h3 class="slider-item-title">
            ...
            @isset($service->subscription_in_service)
              <div class="slider-item" data-image='{{ asset('uploads/images/16565890256275811127252546050275.jpg') }}'>
                <h3 class="slider-item-title">
            ...
            @isset($service->questions)
              <div class="slider-item" data-image='{{ asset('uploads/images/16559725422529600467461009415996.png') }}'>
                <h3 class="slider-item-title">
                  @lang('heading.frequently-asked-questions')
                </h3>

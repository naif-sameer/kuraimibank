    ...
    <form class="space-y-8" @submit.prevent="store.updatePrivacyPolicy">
      <div class="space-y-4">
        ...
        <Input
          ...
          type="text"
          :label="t('privacy_policy.arabic-title')"
        />
        ...
        <Input
          ...
          type="text"
          :label="t('privacy_policy.english-title')"
        />
      </div>
      ...
      <div class="space-y-4">
        <!------ arabic sub_title ------>
        <Input
          v-model="store.item.sub_title.ar"
          type="text"
          :label="t('privacy_policy.arabic-sub_title')"
        />

        <!------ english sub_title ------>
        <Input
          v-model="store.item.sub_title.en"
          type="text"
          :label="t('privacy_policy.english-sub_title')"
        />
      </div>
